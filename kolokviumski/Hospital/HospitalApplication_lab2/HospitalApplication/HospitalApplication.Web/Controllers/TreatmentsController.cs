...
namespace HospitalApplication.Web.Controllers
{
    public class TreatmentsController : Controller
    {
        ...
        public IActionResult Create([Bind("Id,DateAdminstered,FollowUpRequested,PatientId")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,DateAdminstered,FollowUpRequested,PatientId")] Treatment treatment)
        {
            if (id != treatment.Id)
            {
                return NotFound();
        ...
        {
            return _treatmentService.GetById(id) == null ? false : true;
        }
    }
}
